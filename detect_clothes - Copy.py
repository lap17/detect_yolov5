...
def func_detect_clothes():
    ...
    #st.set_page_config(page_title="Clothes Detection Demo", layout="wide", initial_sidebar_state="collapsed")
        ...
        for bbox_data in result:
            ...
            if conf > confidence_threshold:
                ...
                if agree:
                    ...
                    #retval, buffer_img= cv2.imencode('.jpg', img[ymin:(ymax-ymin), xmin:(xmax-xmin)])
    ...
    if prediction_mode == 'Single image':
        ...
        ctx = webrtc_streamer(key="example", video_frame_callback=transform,
            rtc_configuration={"iceServers": [{"urls": ["stun:stun.l.google.com:19302"]}]},
            media_stream_constraints={"video": True, "audio": False}, mode=WebRtcMode.SENDRECV)
